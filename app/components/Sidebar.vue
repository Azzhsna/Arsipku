...
const userMenus = [
  ...
  {
    label: "Kotak Masuk",
    to: "/user/korespondensi/kotak-masuk",
    icon: "i-lucide-inbox",
    badge: 2,
  },
  {
    label: "Terkirim",
    to: "/user/korespondensi/terkirim",
    icon: "i-lucide-send",
  },
  {
    label: "Draft",
    to: "/user/korespondensi/draft",
...
const adminMainMenus = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "Surat Dinas Internal",
        to: "/admin/korespondensi/tulis/surat-dinas-internal",
      },
      {
        label: "Surat Dinas Eksternal",
        to: "/admin/korespondensi/tulis/surat-dinas-eksternal",
      },
  ...
  {
    label: "Kotak Masuk",
    to: "/admin/korespondensi/kotak-masuk",
    icon: "i-lucide-inbox",
    badge: 2,
  },
  {
    label: "Terkirim",
    to: "/admin/korespondensi/terkirim",
    icon: "i-lucide-send",
  },
  {
    label: "Draft",
...
const adminMoreMenus = [
  ...
  },
  {
    label: "Penomoran",
    icon: "i-lucide-hash",
    children: [{ label: "unknown", to: "/admin/penomoran/" }],
  },
  {
    label: "Naskah Dinas",
    to: "/admin/naskah-dinas",
    icon: "i-lucide-file-text",
  },
  {
    label: "Master Data",
    icon: "i-lucide-database",
    children: [{ label: "unknown", to: "/admin/master/" }],
  },
  {
    label: "Laporan",
    icon: "i-lucide-bar-chart-3",
    children: [{ label: "unknown", to: "/admin/laporan/" }],
  },
];

const currentMainMenus = computed(() =>
  route.path.startsWith("/admin") ? adminMainMenus : userMenus
);
const currentMoreMenus = computed(() =>
  route.path.startsWith("/admin") ? adminMoreMenus : []
);
</script>
...
<template>
  ...
  >
    <div
      class="relative h-20 flex items-center border-b border-gray-200 dark:border-gray-800 flex-shrink-0"
    ...
    >
      ...
      <button
        ...
        class="md:hidden absolute right-4 z-20"
      >
        <UIcon
          :name="isMobileOpen ? 'i-heroicons-x-mark' : 'i-heroicons-bars-3'"
          class="w-7 h-7"
        />
      </button>
    </div>
    ...
    <div
      class="flex-1 space-y-1 py-4 px-2 overflow-y-auto custom-scrollbar overflow-x-visible"
    >
      <SidebarItem
