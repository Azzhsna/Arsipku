<template>
  ...
  >
    <!-- HEADER -->
    <div
      class="relative h-20 flex items-center border-b border-gray-200 dark:border-gray-800"
    ...
    >
      ...
      <div class="flex items-center gap-2">
        ...
        <h1 v-if="!collapsed" class="font-bold text-lg whitespace-nowrap">
          ArsipKu
        </h1>
      </div>
    ...
    <button
      ...
      class="hidden md:flex absolute top-6 -right-4 z-50 w-7 h-7 rounded-full bg-white dark:bg-gray-800 shadow-md border border-gray-300 dark:border-gray-700 items-center justify-center"
    >
      <UIcon
  ...
  >
    ...
    >
      <div class="flex items-center gap-2">
        ...
        <h1
          v-if="!collapsed"
          class="font-bold text-lg whitespace-nowrap dark:text-white"
        >
          ArsipKu
        </h1>
      </div>
