<template>
    <div class="relative w-full h-screen overflow-hidden bg-base">
        ...
        <!-- Glow tengah -->
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/2 h-full bg-middleGlow">
        </div>
        ...
        <div class="relative z-10 w-full h-full">
            <!-- Logo -->
            <img src="/logoAirnav.png" :class="logoClass" :style="logoStyle"
            ...
            <!-- Pesawat muncul -->
            <img v-if="showPlane" src="/Pesawat.png" class="absolute left-1/2 transform -translate-x-1/2 plane"
            ...
            <div v-if="showText"
                ...
                <UButton to="/admin/dashboard"
                    class="px-15 py-3 bg-[#457FB6] text-[20px] text-white font-medium rounded-lg hover:bg-[#35629B] transition-colors"
                    :label="$t('Masuk')" trailing-icon="i-heroicons-arrow-right" />
            </div>

            <!-- Onboarding -->
            <div class="relative inline-block group top-120 left-15" v-if="showOnboarding" :class="OnboardingClass"
            ...
            <div class="relative inline-block group top-110 left-210" v-if="showOnboarding" :class="OnboardingClass"
                :style="OnboardingStyle">
                <!-- gambar icon pesawat -->
