...
const toggleSelectAll = () => {
  if (selectedIds.value.size === filteredEmails.value.length)
...
const isAllSelected = computed(
  () =>
    ...
    selectedIds.value.size === filteredEmails.value.length
);
...
<template>
  ...
  >
    <!-- HEADER BAR -->
    <div
      class="h-14 border-b border-gray-200 flex items-center justify-between px-3 shrink-0 z-30 min-w-0"
    >
      <!-- LEFT: checkbox / actions -->
      <div class="flex items-center gap-1 shrink-0">
        <div
          class="p-1.5 rounded hover:bg-gray-100 cursor-pointer transition-colors group"
        ...
        >
          <div
            ...
            :class="{
              ...
              'group-hover:border-gray-600': !isAllSelected,
            }"
          >
            <Check
              v-if="isAllSelected"
        ...
        <button
          class="p-1.5 text-neutral-500 hover:bg-gray-100 hover:text-neutral-900 rounded transition-colors"
          title="Muat Ulang"
        >
        ...
        <template v-if="selectedIds.size > 0">
          ...
          <div
            class="flex items-center gap-1 animate-in fade-in slide-in-from-left-2 duration-200"
          >
            <button
              class="p-1.5 text-neutral-500 hover:bg-red-50 hover:text-error rounded"
            >
              <Trash2 class="w-4 h-4" />
            </button>
            <button
              class="p-1.5 text-neutral-500 hover:bg-blue-50 hover:text-primary rounded hidden sm:block"
            >
      ...
      <div class="flex items-center gap-2 shrink-0 min-w-0">
        ...
        <div
          class="flex items-center gap-1 text-caption1 text-neutral-500 shrink-0"
        >
    ...
    <div class="flex-1 flex overflow-hidden relative w-full">
      ...
      <div
        ...
        :class="
          selected
            ? 'hidden lg:flex lg:w-5/12 xl:w-[450px] shrink-0'
            : 'flex-1 w-full'
        "
      >
        <div
          class="px-3 py-2.5 border-b border-gray-200 bg-white shrink-0 sticky top-0 z-10 w-full overflow-hidden"
        >
          <div class="flex gap-2 overflow-x-auto scrollbar-hide w-full">
            <UButton
              ...
              color="primary"
              class="px-4 py-2 text-sm font-normal rounded-full border transition-all flex items-center gap-1.5 whitespace-nowrap shrink-0 active:bg-primary-100 active:text-primary-500"
              :class="
                activeTab === tab.value
        ...
        <div class="flex-1 pb-10 w-full">
          <div
            ...
            :class="
              selected?.id === mail.id ? 'bg-blue-50/50' : 'hover:bg-gray-50'
            "
          >
            ...
            <div class="flex-1 min-w-0 flex items-center gap-3 overflow-hidden">
              <span
                class="w-28 md:w-40 xl:w-44 truncate text-[13px] text-neutral-900 shrink-0"
              ...
              <div
                class="flex-1 min-w-0 flex items-center text-caption1 text-neutral-500 overflow-hidden"
              >
                <span
                  class="text-neutral-900 truncate mr-1 max-w-[60%] md:max-w-none text-[13px]"
              ...
              <div class="hidden xl:flex shrink-0">
                <span
                  class="px-2 py-[1px] rounded-full text-[11px] font-semibold whitespace-nowrap"
            ...
            <div class="pl-2 shrink-0 flex justify-end w-[65px] md:w-[75px]">
              <span
                class="text-caption2b text-neutral-500 text-[12px] group-hover:hidden whitespace-nowrap"
              >
                {{ mail.date }}
              </span>

              <div
                class="hidden group-hover:flex items-center gap-2 bg-white/90 backdrop-blur-sm pl-2 justify-end"
              >
                <button
                ...
                <button
                  class="text-neutral-500 hover:text-error transition-colors"
                  title="Hapus"
                >
                  <Trash2 class="w-3.5 h-3.5" />
                </button>
                <button
                  class="text-neutral-500 hover:text-neutral-900 transition-colors hidden sm:block"
                  title="Tandai"
                >
      ...
      >
        <div
          class="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-white shrink-0"
        >
          <button
            class="lg:hidden mr-2 p-1.5 hover:bg-gray-100 rounded-full"
            @click="closeDetail"
          >
        ...
        <div class="flex-1 overflow-y-auto p-5 scroll-smooth">
          <div class="flex items-start justify-between mb-6">
            <div class="flex items-center gap-3 overflow-hidden">
              ...
              <div class="min-w-0">
                ...
                >
                  <span class="text-body2b text-neutral-900 truncate">{{
                    selected.from
                  }}</span>
                </div>
          ...
          <div
            class="bg-gray-50/50 border border-gray-100 rounded-lg p-4 mb-6 space-y-3"
          >
            <div
              class="grid grid-cols-[80px_1fr] sm:grid-cols-[100px_1fr] gap-2 items-center"
            >
              <span
                class="text-caption2b text-neutral-400 uppercase tracking-wider"
                >Kategori</span
              >
              <div>
                <span
                  class="px-2 py-0.5 rounded text-caption2b border inline-block"
            ...
            <div
              class="grid grid-cols-[80px_1fr] sm:grid-cols-[100px_1fr] gap-2 items-start"
            >
              <span
                class="text-caption2b text-neutral-400 uppercase tracking-wider pt-0.5"
                >Catatan</span
              >
              <p
                class="text-caption1 text-neutral-600 italic leading-relaxed break-words"
              >
                "{{ selected.note }}"
              </p>
            </div>
          ...
          <div
            class="prose max-w-none text-body2 text-neutral-800 leading-6 break-words"
          >
            <p>{{ selected.body }}</p>
          </div>
        </div>
        ...
        <div class="p-4 border-t border-gray-200 bg-white shrink-0">
          <NuxtLink
            :to="`/user/kotak-masuk/${selected.id}`"
