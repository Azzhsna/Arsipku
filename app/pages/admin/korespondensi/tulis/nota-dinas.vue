...
<template>
  ...
  >
    ...
    <div class="flex-1 overflow-y-auto px-6 py-4 space-y-1">
      <div
        class="flex items-center justify-between py-2 border-b border-gray-200 group"
      >
        <div class="flex items-center w-full">
          <span class="w-30 text-sm text-gray-500 font-medium shrink-0"
            >Pesan</span
          >
          <input
            type="text"
            class="flex-1 outline-none text-gray-900 py-1 bg-transparent text-sm"
      ...
      <div class="flex items-start py-2 border-b border-gray-200">
        <span class="w-30 text-sm mt-1.5 text-gray-500 font-medium shrink-0"
          >Pengirim</span
        >
        <div class="flex flex-wrap gap-1 w-full items-center">
          ...
          >
            ...
            <template #default>
              ...
              <span v-else class="text-gray-400 text-sm"> Pilih Pengirim </span>
            </template>
          </USelectMenu>
        </div>
      </div>
      ...
      <div class="flex items-start py-2 border-b border-gray-200">
        ...
        <div class="flex flex-wrap gap-1 w-full items-center">
          ...
          >
            ...
            <template #default>
              <div
                class="flex items-center gap-1.5 flex-wrap min-h-[2.5rem] pr-10"
              >
                <UBadge
                ...
                >
                  ...
                  <span
                    class="text-xs font-medium text-left truncate max-w-[220px]"
                  >
                    {{ item.label }}
                  </span>
      ...
      <div class="relative py-4">
        ...
        <div
          class="relative transition-all duration-300 ease-in-out flex flex-col border border-neutral-200 border-radius-lg"
          :class="
            isFullscreen
        ...
        >
          ...
          >
            <div class="flex items-center gap-1 flex-wrap" v-if="editor">
              <div
                class="flex items-center gap-1 border-r pr-2 mr-2 border-gray-300"
              >
                <UButton
          ...
          <div
            class="flex-1 overflow-y-auto bg-gray-100 p-8 flex justify-center w-full"
          >
            <div
            ...
            >
              ...
              >
                <label
                  class="text-[10px] text-gray-400 font-bold uppercase mb-1 block opacity-0 group-hover:opacity-100 transition-opacity"
                  >Header</label
                >
                <input
              ...
              <div
                class="flex-1 px-10 py-2 cursor-text"
