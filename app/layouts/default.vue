<template>
  <div class="flex h-full min-h-screen text-gray-900 dark:text-white">
    ...
    <div
      class="flex-1 flex flex-col min-h-screen transition-all duration-300 bg-gray-50 dark:bg-[#051321]"
      :class="collapsed ? 'md:ml-20' : 'md:ml-64'"
    >
      <nav
        class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 h-20 px-4 flex items-center justify-between sticky top-0 z-30 transition-colors duration-300"
      >
        <div class="flex items-center gap-3">
          ...
          <h1
            class="font-bold text-xl tracking-tight text-gray-900 dark:text-white md:hidden"
          >
            ArsipKu
          </h1>
        </div>
        ...
        <div class="flex items-center gap-3 md:gap-5">
          ...
          <div
            class="h-6 w-px bg-gray-200 dark:bg-gray-700 hidden md:block"
          ></div>
          ...
          >
            ...
            <button
              ...
              :class="
                isDark
                  ? 'bg-gray-700 text-yellow-300 shadow-sm scale-105'
                  : 'text-gray-400 hover:text-gray-600'
              "
            >
